...
# Execution phase mapping: phase_id → list of (section_label, folder_id)
PHASE_DATAROOM_FOLDERS: dict[str, list[tuple[str, str]]] = {
    "phase1": [
        ("1. Corporate Structure & Governance", "1T1Bb-0iQ5-2FT4FmQMDDjqR2EO07mBky"),
        ("2. Legal", "16NmAbpTm0OCd1VkXq2D6IT7EGPnTlieR"),
        ("3. Financials", "1HLASIzqtU_C4ZpuwYaoD4jlfv_nUCbS_"),
    ],
    "phase2": [
        ("2.2 Intercompany Agreements", "1thyxhc0xoGg2f7C541u9tOWNf7q1AzUf"),
